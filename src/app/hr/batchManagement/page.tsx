...
export default function AddBatchPage() {
  ...
  //   try {
  //     const res = await fetchWithAuth(
  //       'https://api.easycoders.in/projects/backend/public/api/commanAPIs/users?role=trainer'
  //     );
  //     setTrainers(res || []);
  //   } catch {
  ...
  const toggleTrainer = (id: number) => {
    setForm((p) => ({
      ...p,
      trainer_ids: p.trainer_ids.includes(id)
        ? p.trainer_ids.filter((t) => t !== id)
        : [...p.trainer_ids, id],
    }));
  };
  ...
  const submitBatch = async () => {
    try {
      ...
      await fetchWithAuth(
        'https://api.easycoders.in/projects/backend/public/api/batches',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload),
      ...
      <div className={styles.wrap}>
        ...
        <header className={styles.topbar}>
          <div className={styles.left}>
            <div className={styles.crumbs}>
              <Link href="/admin" className={styles.crumbLink}>Admin</Link>
              <span className={styles.crumbSep}>/</span>
              <span className={styles.crumbNow}>Add Batch</span>
            </div>
        ...
        <section className={styles.card}>
          <div className={styles.cardHeader}>
            <div className={styles.cardIcon}>📦</div>
            <div>
              <div className={styles.cardTitle}>Batch Details</div>
              <div className={styles.cardSubtitle}>Basic batch information</div>
            </div>
          </div>
        ...
        <section className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <div>
              ...
              <div className={styles.cardSubtitle}>Batch timeline</div>
            </div>
          </div>
        ...
        <section className={styles.card}>
          <div className={styles.cardHeader}>
            <div className={styles.cardIcon}>👨‍🏫</div>
            <div>
              <div className={styles.cardTitle}>Assign Trainers</div>
              <div className={styles.cardSubtitle}>Select trainers for this batch</div>
            </div>
          </div>
          ...
          <div className={styles.cardBody}>
            <div className={styles.formGrid}>
              {trainers.map(t => (
                <div key={t.id} className={styles.checkboxRow}>
                  <input
                    type="checkbox"
