  ...
  return (
    <>
      <style>{`
        ...
        .thanks-btn:hover { background: #ea6500; transform: translateY(-1px); }
      `}</style>
        ...
        <div className="thanks-overlay" onClick={handleThanksClose}>
          <div className="thanks-card" onClick={e => e.stopPropagation()}>
            ...
            <p className="thanks-body">
              Your message has been received. Our team will get back to you within <strong>24 hours</strong>.
            </p>
            <button className="thanks-btn" onClick={handleThanksClose}>
              Back to Home →
            </button>
          </div>
        </div>
