    ...
    <RoleGuard allowedRoles={[1]}>
      ...
      >
        <AdminCardGrid>
          ...
          <AdminCard
            href="/admin/easy-assess/playground"
            title="Playground Limits"
            description="Set how many saved codes each student can keep in the Code Playground and the maximum size of each snippet."
            icon={
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <AdminCard
            href="/admin/easy-assess/menu-access"
            title="Student Access"
            description="Control which Easy Assess menus each student type can see — direct sign-ups vs enrolled EasyCoders students."
            icon={
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
