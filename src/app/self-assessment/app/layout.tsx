    ...
    <>
      ...
      <div className="aa-layout">
        ...
        <div className="aa-mobile-bar">
          ...
          <span className="aa-mobile-logo"><img src="/images/ec_logo.png" alt="EasyCoders" style={{ height: 26, width: 'auto' }} /></span>
        ...
        <aside className={['aa-sidebar', !isMobile && collapsed ? 'collapsed' : '', isMobile && mobileOpen ? 'mobile-open' : ''].filter(Boolean).join(' ')}>
          ...
          <div className="aa-logo-wrap">
            <div className="aa-logo-card">
              <img
                src={(!isMobile && collapsed) ? '/images/ecnobackground.png' : '/images/ec_logo.png'}
                alt="EasyCoders"
                style={{ height: (!isMobile && collapsed) ? 32 : 46, width: 'auto', maxWidth: '100%', objectFit: 'contain', display: 'block' }}
              />
            </div>
          </div>
